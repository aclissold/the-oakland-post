...
private let messages = [
    ...
    kPFErrorUserEmailTaken: "The provided email address has already been taken. Please choose another or tap \"Forgot your password?\" on the login page.",
    ...
    kPFErrorUsernameTaken: "The provided username has already been taken. Please choose another or tap \"Forgot your password?\" on the login page.",
